  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`absolute top-0 right-0 h-full w-64 overflow-y-auto border-l border-gray-200/60 dark:border-white/10 bg-white/80 dark:bg-black/80 backdrop-blur-xl shadow-2xl transition-all duration-300 ${
